...
const NavLinks: React.FC<{ className?: string }> = ({ className }) => (
  <>
    ...
    <a href="#solution" className={className}>
      Our Process
    </a>
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:block">
            <button
              ...
              className="bg-brand-blue text-white px-6 py-3 rounded-full hover:bg-brand-blue-dark transition-all duration-300 font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Free Consultation
            </button>
          </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 pt-4 pb-8 space-y-4 flex flex-col items-center">
            ...
            <button
              ...
              className="mt-4 w-full text-center bg-brand-blue text-white px-6 py-3 rounded-full hover:bg-brand-blue-dark transition font-semibold"
            >
              Free Consultation
            </button>
          </div>
